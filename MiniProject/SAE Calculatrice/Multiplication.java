public class Multiplication extends Operation {
    ...
    //constructeur
  public Multiplication(Expressions n1,Expressions n2){
      super(n1,n2);
  }
...
public String toString(){
  if (super.getOperande1() instanceof Operation == true &&super.getOperande2() instanceof Operation == true) {
    return "("+super.getOperande1().toString()+"x"+super.getOperande2().toString()+")";

  }

else if (super.getOperande1() instanceof Operation == true) {
  return "("+super.getOperande1().toString()+"x"+super.getOperande2().valeur()+")";

  }
else  if (super.getOperande2() instanceof Operation == true) {
  return "("+super.getOperande1().valeur()+"x"+super.getOperande2().toString()+")";
